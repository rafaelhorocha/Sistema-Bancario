...
Um sistema bancário orientado a objetos desenvolvido em **Python**, com suporte a clientes, contas correntes, depósitos, saques, extrato e gerenciamento de usuários.  
...
| **Funções Procedurais** | `menu`, `depositar`, `sacar`, `exibir_extrato`, `criar_usuario`, `criar_conta`, `listar_contas` |
